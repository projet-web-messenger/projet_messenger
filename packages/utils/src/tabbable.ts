...
const isHTMLElement = (element: unknown): element is HTMLElement => typeof element === "object" && element !== null && (element as Dict).nodeType === 1;
 ...
 */
export const getFocusables = (container: Pick<HTMLElement, "querySelectorAll"> | null, includeContainer: IncludeContainerType = false) => {
  if (!container) {
    return [];
  }
 ...
 */
export function getTabbableEdges(container: HTMLElement | null, includeContainer?: IncludeContainerType): [HTMLElement, HTMLElement] | [null, null] {
  const elements = getTabbables(container, includeContainer);
